...
//  Stylesheets
define('SW_STYLESHEET', 'stylesheet/tslicenses.css');
...
define('SW_DB_USER', 'usrSai');
define('SW_DB_PASSWORD', 'usrSai321');
define('SW_DB_HOST', '127.0.0.1');
//define('SW_DB_DATABASE', 'DEVER_SAI');
define('SW_DB_DATABASE', 'sai_caracol');
}
...
//-----------------------------------
//20140314-azlara-added to configure logo
define('PDF_HEADER_IMAGE', '../public/images/logo_iasd.jpg');
define('PDF_HEADER_XPOS', '15'); 
define('PDF_HEADER_YPOS', '10');
define('PDF_HEADER_WIDTH', '100');//450
//-----------------------------------
