...
{if $SHOW_OUTPUT}
        <TR>
            <td>
			<div style="width: 15%; padding-top: 15px;float: left;vertical-align: bottom;text-align: center;display:none!important;">
                <b>{$T_REPORT_STYLE}</b>
			...
			<div class="swPrpToolbarPane" style="width: 35%; float: left; vertical-align: bottom;text-align: right;display:none!important;">
{if $SHOW_DESIGN_BUTTON}
...
{/if}
			...
			<div style="width: 50%; padding-top: 15px;float: left;vertical-align: bottom;text-align: center;display:none!important;">
                                  <b>{$T_SHOW}</b>
...
<div class="smallbanner"><a href="http://www.technosoft.com" target="_blank">TechnoSoft Inc. &copy;&nbsp;{php}echo(date("Y"));{/php}</a></div>
</div>
{if !$REPORTICO_AJAX_CALLED} 
{if !$EMBEDDED_REPORT} 
</BODY>
